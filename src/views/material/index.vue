  ...
  <el-card v-loading="loading">
    ...
    <el-tabs v-model="activeName" @tab-click="changeTab">
      <el-tab-pane label="全部素材" name="all">
        <!-- 全部素材 -->
        <div class="img-list">
          <el-card class="img-item" v-for="(item,index) in list" :key="item.id">
            <img @click="showImgDialog(index)" :src="item.url" alt />
            <div class="operate">
              <!-- 收藏和取消收藏 -->
              <i
    ...
    <el-dialog @opened="setActiveItem" :visible="dialogVisible" @close="dialogVisible = false">
      <el-carousel  ref="myCarousel" :interval="4000"  height="500px">
        <el-carousel-item class='carosel-item' v-for="(item,index) in list" :key="index">
...
export default {
  ...
  methods: {
    ...
    // 设置激活样式
    setActiveItem () {
      this.$refs.myCarousel.setActiveItem(this.openIndex)
    },
    // 取消或者收藏
